/* 
 * Creates artPiece object that stores all variables for
 * image creation on DOM
 */
...
db.onload = function() {
    if(db.status === 200) {
        ...
        for(var i = 0; i < pieces.artPiece.length; i++){
            ...
            tba.showImage("drawingrow");
        }
        
    }
};
db.open('GET', "drawing.json", true);
db.send(null);
